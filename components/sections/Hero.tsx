  ...
  return (
    <div className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center justify-start text-center min-h-screen pt-24 pb-20 space-y-6">
          {/* Main title */}
          ...
          {/* Tagline with better formatting */}
          <div className="max-w-3xl mx-auto space-y-4">
            <p className="text-base md:text-lg theme-text-cream leading-relaxed max-w-2xl mx-auto opacity-90">
      ...
      >
        <svg
          className="w-8 h-8 theme-text-red transition-transform duration-300 group-hover:translate-y-1"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
