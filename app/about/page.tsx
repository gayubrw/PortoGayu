      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-24 grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="portfolio-card p-2 aspect-square relative overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute top-0 left-0 w-5 h-5 border-t border-l border-theme-red"></div>
            <div className="absolute top-0 right-0 w-5 h-5 border-t border-r border-theme-red"></div>
            <div className="absolute bottom-0 left-0 w-5 h-5 border-b border-l border-theme-red"></div>
            <div className="absolute bottom-0 right-0 w-5 h-5 border-b border-r border-theme-red"></div>
          </div>

          {/* Bio content */}
          <div className="lg:col-span-2 space-y-6">
            <h2 className="text-2xl font-bold theme-text-red mb-6 relative">
            ...
            {Array.isArray(personalInfo.bio) ? (
              personalInfo.bio.map((paragraph, index) => (
                <p key={index} className="theme-text-cream">
                  {paragraph}
                </p>
              ))
            ) : (
          ...
          <div className="mb-24">
            ...
            <h2 className="text-2xl font-bold theme-text-red mb-12 lg:text-center">
              <span className="relative">
                Work Experience
                <span className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 h-px w-12 theme-bg-red"></span>
              </span>
            </h2>

            {/* Timeline style work experience items */}
                  ...
                  <div className="portfolio-card hover-lift p-6 relative">
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <h3 className="text-xl font-bold theme-text-cream">
                          {work.position}
                        </h3>
                        <div className="text-sm theme-text-red">
                          {work.period}
                        </div>
                      </div>

                      <div className="text-lg theme-text-cream">
                        {work.company}
                      </div>

                      <p className="theme-text-cream">{work.description}</p>

                      {/* Achievements */}
                      {work.achievements && work.achievements.length > 0 && (
                        <div className="mt-4">
                          <h4 className="text-sm font-semibold theme-text-red mb-2">
                            Key Achievements:
                          </h4>
                          <ul className="list-disc list-inside space-y-1 theme-text-cream text-sm">
                ...
                <div className="portfolio-card hover-lift p-6 relative">
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="text-sm theme-text-red">{exp.period}</div>
                    </div>
                    ...
                    <p className="theme-text-cream">{exp.description}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {education.map((edu, index) => (
              <div key={index} className="portfolio-card hover-lift p-6">
                <h3 className="text-xl font-bold theme-text-cream mb-2">
                  {edu.degree}
                </h3>
                <div className="text-lg theme-text-cream mb-2">
                  {edu.institution}
                </div>
                <div className="text-sm theme-text-red mb-4 pb-4 border-b border-theme-red">
                  {edu.period}
                </div>
                <p className="theme-text-cream">{edu.description}</p>
              </div>
            ))}
          </div>
        </div>
